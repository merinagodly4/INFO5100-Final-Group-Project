 ...
 * @author lajon
 */
public class SupplierDataAnalystOrdersJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private SupplierDataAnalyticsOrganization retailAnalyticsOrganization;
    private Enterprise enterprise;
    /**
     * Creates new form RequestDataAnalystInventoryJPanel
     */
    public SupplierDataAnalystOrdersJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business, Enterprise enterprise) {
         this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.retailAnalyticsOrganization = (SupplierDataAnalyticsOrganization) organization;
