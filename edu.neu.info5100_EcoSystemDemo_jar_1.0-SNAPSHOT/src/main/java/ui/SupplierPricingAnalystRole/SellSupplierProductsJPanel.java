 ...
 * @author kens2
 */
public class SellSupplierProductsJPanel extends javax.swing.JPanel {
    JPanel userProcessContainer;
    WholesaleMasterOrderList masterOrderList;
    WholesaleOrder currentOrder;
    SupplierProductCatalog productCatalog;
    
    public SellSupplierProductsJPanel(JPanel userProcessContainer, EcoSystem business) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.masterOrderList = business.getWholesaleMasterOrderList();
